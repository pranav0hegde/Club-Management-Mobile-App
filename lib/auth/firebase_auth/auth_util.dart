...
DocumentReference? get currentUserReference =>
    loggedIn ? ClubmanagementRecord.collection.doc(currentUser!.uid) : null;

ClubmanagementRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ClubmanagementRecord.getDocument(
                  ClubmanagementRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
