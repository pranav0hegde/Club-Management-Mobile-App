...
import 'inksanity_model.dart';
export 'inksanity_model.dart';

class InksanityWidget extends StatefulWidget {
  const InksanityWidget({super.key});

  @override
  State<InksanityWidget> createState() => _InksanityWidgetState();
}

class _InksanityWidgetState extends State<InksanityWidget> {
  late InksanityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InksanityModel());
